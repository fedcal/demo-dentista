  ...
  template: `
    <header class="site-header">
      <div class="site-header__inner">
        <a routerLink="/" class="brand" aria-label="Home Studio Mariani">
          <span class="brand__icon" aria-hidden="true">🦷</span>
          <span class="brand__text">Studio Mariani</span>
        </a>
        <nav class="site-nav" aria-label="Navigazione principale">
          ...
          <a routerLink="/contatti" routerLinkActive="is-active" class="cta">Prima visita gratuita</a>
        </nav>
      </div>
    </header>
  `,

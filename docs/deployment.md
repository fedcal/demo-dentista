...
URL: `https://dentista.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `dentista.demo.federicocalo.dev`
...
- Output directory: `dist/dentista/browser`
...
URL: `https://fedcal.github.io/federico-demo-dentista/`
...
- `base: /federico-demo-dentista/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `dentista-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   dentista-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `dentista-docs.federicocalo.dev`

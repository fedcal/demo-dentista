...
hero:
  name: "Demo Studio Dentistico"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://dentista.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-dentista
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Studio Dentistico.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Studio Dentistico** in Italia.
...
Il mercato italiano delle PMI per **Studio Dentistico** ha caratteristiche specifiche:
...
- [GitHub repo](https://github.com/fedcal/federico-demo-dentista)
